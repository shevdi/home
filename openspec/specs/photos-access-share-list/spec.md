# photos-access-share-list Specification

## Purpose

Specify photo `accessedBy` persistence, list and detail visibility for private photos shared to named users, admin-only share mutations, admin user-suggestion API for the share picker, and cache keys that vary by viewer segment.
