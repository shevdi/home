# ui-kit-form-field Specification

## Purpose

Define requirements for the `Field` and `TextField` components in `@shevdi-home/ui-kit` and their integration with react-hook-form in the client (state stays in RHF; ui-kit is presentational).
