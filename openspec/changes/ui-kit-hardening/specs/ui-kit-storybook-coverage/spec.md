# UI Kit Storybook Coverage

## Purpose

Define minimum Storybook documentation for exported `@shevdi-home/ui-kit` components so regressions are visible and APIs are discoverable during inner-loop development.
